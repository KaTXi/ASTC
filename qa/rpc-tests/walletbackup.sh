...
B4ARGS="-datadir=$D4"
$ASTURCOIND $ASTURCOINDARGS $B4ARGS &
B4PID=$!
...
B3ARGS="-datadir=$D3"
$ASTURCOIND $ASTURCOINDARGS $B3ARGS &
B3PID=$!
...
function StartThree {
  $ASTURCOIND $ASTURCOINDARGS $B1ARGS &
  B1PID=$!
  $ASTURCOIND $ASTURCOINDARGS $B2ARGS &
  B2PID=$!
  $ASTURCOIND $ASTURCOINDARGS $B3ARGS &
  B3PID=$!
}
