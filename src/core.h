...
#ifndef ASTURCOIN_CORE_H
#define ASTURCOIN_CORE_H
...
static const int64_t MAX_MONEY = 10000000 * COIN; // AsturCoin: maximum of 100 000 000 coins (given some randomness), max transaction 100 000 000
