...
AsturCoinUnits::AsturCoinUnits(QObject *parent):
...
bool AsturCoinUnits::valid(int unit)
{
    switch(unit)
    {
    case AST:
...
QString AsturCoinUnits::name(int unit)
{
    switch(unit)
    {
...
QString AsturCoinUnits::description(int unit)
{
    switch(unit)
    {
...
qint64 AsturCoinUnits::factor(int unit)
{
    switch(unit)
    {
...
qint64 AsturCoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
...
int AsturCoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
...
int AsturCoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case AST: return 8;
...
QString AsturCoinUnits::format(int unit, qint64 n, bool fPlus)
{
...
QString AsturCoinUnits::formatWithUnit(int unit, qint64 amount, bool plussign)
{
    return format(unit, amount, plussign) + QString(" ") + name(unit);
}

bool AsturCoinUnits::parse(int unit, const QString &value, qint64 *val_out)
{
...
int AsturCoinUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant AsturCoinUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
