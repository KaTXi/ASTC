...
#ifndef _ASTURCOINRPC_CLIENT_H_
#define _ASTURCOINRPC_CLIENT_H_ 1
...
/** Show help message for asturcoin-cli.
 ...
 *
 * @note the argument can be removed once asturcoin-cli functionality is removed from asturcoind
 */
