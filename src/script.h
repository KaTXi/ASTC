...
#ifndef H_ASTURCOIN_SCRIPT
#define H_ASTURCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CAsturCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, AsturCoin always counted CHECKMULTISIGs
